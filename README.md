...
YOUR_JOB_LINK_PATTERN - جزء ثابت من رابط إعلانات الوظائف بموقعك (مثل jobs أو vacancy) - طريقة إيجاده موجودة بدليل الاستيراد

YOUR_APPLY_LINK_TEXT - نص الزر أو الرابط اللي يودي لصفحة التقديم بموقعك - طريقة إيجاده موجودة بدليل الاستيراد

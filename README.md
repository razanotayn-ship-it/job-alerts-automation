...
الفكرة انه كل ربع ساعة الأتمتة تروح للموقع وتشتغل على الوظائف الجديدة وبعدين تبعتلك بريد فيه تفاصيل الوظيفة.
...
ملف المتغيرات اللي تحتاجها أو تحتاجه

---

كيف تستخدمه

1. حمّل/ي الملف jobs-workspace-26.json من هنا

2. ادخل/ي https://app.n8n.cloud وسجّل/ي دخول

3. اضغط/ي Import واختار/ي الملف

![قائمة الاستيراد في n8n](screenshots/import-step.jpg)
4. بعدين ملّ/ي البيانات الحقيقية:
...
6. شغّل/ي الأتمتة وبيشتغل تلقائيا
...
أنت/ِ اللي بتحط/ي البيانات الحقيقية عند الاستيراد.
